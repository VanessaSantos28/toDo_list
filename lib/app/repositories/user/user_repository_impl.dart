    ...
    try {
      ...
      if (e.code == 'email-already-in-use') {
        ...
        if (loginTypes.contains('password')) {
          ...
          throw AuthException(
              message:
                  'Você se cadastrou pelo TodoList pelo Google, por favor utilize ele para entrar');
        }
      } else {
    ...
    try {
      ...
      if (googleUser != null) {
        ...
        if (loginMethods.contains('password')) {
          throw AuthException(
              message:
                  'Você utilizou o e-mail para cadastro no TodoList, caso tenha esquecido sua senha, por favor, clique na opção esqueci minha senha');
        } else {
